...
public class ConsoleLogger {
    ...
    private static final String APP_NAME = "Propergol";
    private static int barLengh = 100;
    ...
    public static void printStacktrace(Throwable throwable, String... messages) {
        ...
        System.err.println(prefixt + "comes from a poor configuration of " + APP_NAME + ", we invite you to look at your settings");
